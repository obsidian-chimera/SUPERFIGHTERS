...
def init():
    ...
    #screen = pygame.display.set_mode([pygame.display.get_desktop_sizes],flags=pygame.FULLSCREEN,depth=0,display=0,vsync=0) #A bit more complex here in that it renders the display to my monitor's resolution, 
    ...
    display_list = pygame.display.get_desktop_sizes()
